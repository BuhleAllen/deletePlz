...
/******/ 			var chunk = require("./" + ({"1":"components/hero","2":"components/loading","3":"pages/index","4":"pages/movies/_movieid"}[chunkId]||chunkId) + ".js");
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(6).default("2df02992", content, true)
...
var ___CSS_LOADER_API_IMPORT___ = __webpack_require__(5);
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
___CSS_LOADER_EXPORT___.push([module.i, "@import url(https://fonts.googleapis.com/css2?family=Karla:wght@200;300;400;500;600&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*{margin:0;padding:0;box-sizing:border-box;font-family:\"Karla\",sans-serif;scroll-behavior:smooth}.page-enter-active,.page-leave-active{transition:opacity .5s}.page-enter,.page-leave-to{opacity:0}.app{background-color:#211f1f;min-height:100vh}.button{display:inline-block;text-decoration:none;color:inherit;padding:8px 16px;background-color:#c92502;border:none;color:#fff;border-radius:4px;cursor:pointer;transition:all .3s ease}.button:hover{background-color:#891b02}.button-light{background-color:transparent;border:1px solid #c92502}.button-light:hover{border-color:transparent}.container{max-width:1400px;margin:0 auto}.loading{height:100vh;width:100%;display:flex;justify-content:center;align-items:center}@-webkit-keyframes circle-loading{to{transform:rotate(1turn)}}@keyframes circle-loading{to{transform:rotate(1turn)}}.loading span{display:block;width:70px;height:70px;border-radius:50%;border:2px solid transparent;border-top-color:#fff;-webkit-animation:circle-loading 1.2s ease infinite;animation:circle-loading 1.2s ease infinite}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const _753e0f15 = () => interopDefault(__webpack_require__.e(/* import() | pages/movies/_movieid */ 4).then(__webpack_require__.bind(null, 38)));

const _1b7548cf = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 3).then(__webpack_require__.bind(null, 39)));
...
// EXTERNAL MODULE: ./assets/defaults.scss
var defaults = __webpack_require__(20);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=d07ca55a&
var defaultvue_type_template_id_d07ca55a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app"},[_c('Nuxt',{attrs:{"keep-alive":""}})],1)}
var defaultvue_type_template_id_d07ca55a_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=d07ca55a&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_d07ca55a_render,
  defaultvue_type_template_id_d07ca55a_staticRenderFns,
  false,
  null,
  null,
  "9849aa68"
...
const Hero = () => __webpack_require__.e(/* import() | components/hero */ 1).then(__webpack_require__.bind(null, 33)).then(c => wrapFunctional(c.default || c));
const Loading = () => __webpack_require__.e(/* import() | components/loading */ 2).then(__webpack_require__.bind(null, 27)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
